report 50180 "Hader Standard Sales - Invoice"
{
    RDLCLayout = './Reports/Hader_StandardSalesInvoice.rdl';
    ...
    dataset
    {
        dataitem(Header; "Sales Invoice Header")
        {
            ...
            begin
                ...
                // NIP 06.09.2021 PaymentInstructionsTxt := O365SalesInvoiceMgmt.GetPaymentInstructionsFromPostedInvoice(Header);
